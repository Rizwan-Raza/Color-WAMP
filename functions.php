...
function color_wamp_styles()
{
    ...
    .primary-hover:hover,
    #footer::before {
        background-color: " . esc_attr(get_theme_mod("color_wamp_theme_color_setting", "#3d85c6")) . " !important;
    }
    .primary-text,
    .primary-text-hover:hover {
        color: " . esc_attr(get_theme_mod("color_wamp_theme_color_setting", "#3d85c6")) . " !important;
    }
    a {
        color: " . esc_attr(get_theme_mod("color_wamp_theme_color_setting", "#3d85c6")) . ";
    }
...
function color_wamp_customizer_panel($wp_customize)
{
    ...
    $color_wamp_social_links = array(
        'color_wamp_social_f'   => array(
            'id'      => 'color_wamp_social_f',
            'title'   => 'Facebook',
            'default' => '',
        ),
        'color_wamp_social_t'    => array(
            'id'      => 'color_wamp_social_t',
            'title'   => 'Twitter',
            'default' => '',
        ),
        'color_wamp_social_l'  => array(
            'id'      => 'color_wamp_social_l',
            'title'   => 'Linkedin',
            'default' => '',
        ),
        'color_wamp_social_i'  => array(
            'id'      => 'color_wamp_social_i',
            'title'   => 'Instagram',
            'default' => '',
        ),
        'color_wamp_social_p'  => array(
            'id'      => 'color_wamp_social_p',
            'title'   => 'Pinterest',
            'default' => '',
        ),
        'color_wamp_social_y'    => array(
            'id'      => 'color_wamp_social_y',
            'title'   => 'YouTube',
            'default' => '',
        ),
        'color_wamp_social_tu' => array(
            'id'      => 'color_wamp_social_tu',
            'title'   => 'Tumblr',
            'default' => '',
        )
    );
