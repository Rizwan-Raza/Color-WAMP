<?php while (have_posts()) {
    ...
    <?php if (has_post_thumbnail()) {
        ...
        ?> </div>
            ...
            <span class="left mr-2"><a href="<?php echo esc_attr(get_comments_link())?>" class="grey-text primary-text-hover"><i class="material-icons left mr-1">forum</i> <?php esc_html(comments_number())?> </a></span>
